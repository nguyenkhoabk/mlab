<?php    
class ControllerSaleStudent extends Controller { 
	private $error = array();
  
  	public function index() {
		$this->load->language('sale/student');
		 
		$this->document->setTitle($this->language->get('heading_title'));
		
		$this->load->model('sale/student');
  ...
  /*
    ...
    */
  	private function getList() {
		...
		if (isset($this->request->get['page'])) {
  		...
  		$this->data['breadcrumbs'] = array();
   		...
   		$this->data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('sale/student', 'token=' . $this->session->data['token'] . $url, 'SSL'),
      		'separator' => ' :: '
   		);
		...
		$student_total = $this->model_sale_student->getTotalStudents($data);
	
		$results = $this->model_sale_student->getStudents($data);
		...
		$this->data['column_khoahoc'] = $this->language->get('column_khoahoc');
        $this->data['column_job'] = $this->language->get('column_job');
		//end 06-07-2014
		...
		*/
		...
		$this->data['sort_name'] = $this->url->link('sale/student', 'token=' . $this->session->data['token'] . '&sort=name' . $url, 'SSL');
		$this->data['sort_email'] = $this->url->link('sale/student', 'token=' . $this->session->data['token'] . '&sort=c.email' . $url, 'SSL');
		...
		*/
		...
		$customer_total = $this->model_sale_student->getTotalStudents($data);
		$pagination = new Pagination();
		$pagination->total = $customer_total;
		$pagination->page = $page;
		$pagination->limit = $this->config->get('config_admin_limit');
		$pagination->text = $this->language->get('text_pagination');
		$pagination->url = $this->url->link('sale/student', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
		...
		$this->template = 'sale/student_list.tpl';
		$this->children = array(
			'common/header',
			'common/footer'
		);
